...
import { Etudiant } from '../../models/etudiant'; // Import the 'Etudiant' class from the correct file path
import { IEtudiant } from '../../models/ietudiant'; // Import the 'IEtudiant' interface from the correct file path
...
export class EtudiantParisComponent implements OnInit {
  ...
  ]; // Définir la propriété 'etudiants'

  constructor() { }

  ngOnInit(): void {
    // Remplir la propriété 'etudiants' avec les données réelles
  }
}